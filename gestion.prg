...
DEFINE PAD _msm_edit OF _MSYSMENU PROMPT "Edición" COLOR SCHEME 3 ;
	KEY ALT+E, "" ;
	MESSAGE "Manipulación de Textos y Objeto OLE"
...
DEFINE BAR _med_undo OF _medit PROMPT "\<Deshacer" ;
	KEY CTRL+Z, "Ctrl+Z" ;
	MESSAGE "Deshace la última acción de edición"
DEFINE BAR _med_redo OF _medit PROMPT "\<Repetir" ;
	KEY CTRL+R, "Ctrl+R" ;
	MESSAGE "Repite la última acción de edición"
DEFINE BAR _med_sp100 OF _medit PROMPT "\-"
DEFINE BAR _med_cut OF _medit PROMPT "Cor\<tar" ;
	KEY CTRL+X, "Ctrl+X" ;
	MESSAGE "Corta la selección y la coloca en el portapapeles"
DEFINE BAR _med_copy OF _medit PROMPT "\<Copiar" ;
	KEY CTRL+C, "Ctrl+C" ;
	MESSAGE "Copia la selección y la coloca en el portapapeles"
DEFINE BAR _med_paste OF _medit PROMPT "\<Pegar" ;
	KEY CTRL+V, "Ctrl+V" ;
	MESSAGE "Inserta el contenido del portapapeles en el punto de inserción"
...
DEFINE BAR _med_clear OF _medit PROMPT "Borrar" ;
	MESSAGE "Elimina la selección sin colocarla en el portapapeles"
...
DEFINE BAR _med_cvtst OF _medit PROMPT "Con\<vierte a Estático" ;
	MESSAGE "Cambia el Objecto vinculado o incrustado a una imagen estática"
...
@ 5.231,14.500 GET m.status ;
	PICTURE "@^ En trámite;Archivado;Recibido" ;
	SIZE 1.538,21.800 ;
	DEFAULT "En trámite" ;
	FONT "MS Sans Serif", 8 ;
	WHEN isediting
...
@ 11.769,14.500 GET m.tipo ;
	PICTURE "@^ Oficio Original ;Copia de oficio;Volante de Turno ;CD ;Correo Electrónico ;Circular ;Nota Informativa ;Otros" ;
	SIZE 1.538,21.600 ;
	DEFAULT "Oficio Original " ;
	FONT "MS Sans Serif", 8 ;
	WHEN isediting
@ 13.462,14.500 GET m.instruc ;
	PICTURE "@^ ATENCION;Comentario;Enviar Oficio de Resp.;Elaborar Informe y Comentar;Conocimiento;Preparar Nota Informativa;Archivar;Asistir en Representación;Otro" ;
	SIZE 1.538,31.200 ;
	DEFAULT "." ;
	FONT "MS Sans Serif", 8 ;
	WHEN isediting
...
PROCEDURE pdialog
	...
	@ 4.692,7.200 GET m.p_recs ;
		PICTURE "@*RVN \<Registro Actual;\<Selección" ;
